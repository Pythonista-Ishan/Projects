...
root.title("Encryption And Decryption by Ishan Jaiswal")





Label(root, text ='Encryption And Decryption', font = 'arial 20 bold').pack()
Label(root, text ='Ishan Jaiswal', font = 'arial 20 bold').pack(side =BOTTOM)
